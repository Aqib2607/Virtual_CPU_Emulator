...
def week_8_optimization():
    ...
    memory = ["000101000010", "001010000001", "111100000000"]  # ADD, SUB, HALT
    registers = [0b000000] * 4
    pc = 0
...
def week_9_testing_debugging():
    """
    Week 9: Perform extensive testing and debugging on the emulator.
    """
    memory = ["000101000001", "001010000001", "000101000001", "111100000000"]  # ADD, SUB, ADD, HALT
    registers = [0b000000] * 4
    pc = 0
...
outputs = {
    ...
    "week_9_testing_debugging": week_9_testing_debugging(),

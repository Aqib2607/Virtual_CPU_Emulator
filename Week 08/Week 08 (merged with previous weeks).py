...
def emulator():
    return decode_instructions(instructions)
...
def emulator_optimized():
    return decode_instructions_optimized(instructions)
...
print("Profiling Original Emulator:")
profile_emulator(emulator)

# Output of Original Emulator
print("Original Emulator Output (Binary):")
print(emulator())

# Profiling Optimized Emulator
print("\nProfiling Optimized Emulator:")
profile_emulator(emulator_optimized)

# Output of Optimized Emulator
print("Optimized Emulator Output (Binary):")
print(emulator_optimized())
